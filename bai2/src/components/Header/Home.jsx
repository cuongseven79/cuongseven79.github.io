...
// ------------------------------------ START -------------------------------------
          return (
            ...
            <div className="slider">
              ...
              <span className="home-header">Sản phẩm mới<div className="underline"><span></span></div> </span>
              <div className="home-body">
                {newProduct.map((television) => (
                  ...
                  {/* Show -- Cart */}
                    <section className="gallery-cart">
