...
//                            {bepgas.map((gas) => ( 
//                               <div className="item">
//                                    <div className="image-item"> <img src={gas.image} alt="hinh TV" /></div>
//                                    <div className="logo-guarantee-item"> <img src="https://www.eyewearus.com/images/satisfaction-guarantee-seal-icon.jpg" alt="logo bảo hành" /> </div>
//                                    <div className="service-item">
//                                         <img src="https://quamienbac.com/wp-content/uploads/2020/07/van-chuyen.png" alt="icon-shipping" />
